...
- PulseBoard Canary turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact single-page tool called PulseBoard Canary. It should show three status panels, a small activity timeline, a filter control, and a details drawer. Use plain HTML/CSS/JS only, persist state in localStorage, and include clear empty/error/recovery states.
...
- Record Operations - PulseBoard Canary
- Record Editor - PulseBoard Canary
- Settings and Preferences - PulseBoard Canary
- Empty and Error Recovery - PulseBoard Canary

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - PulseBoard Canary
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - PulseBoard Canary
...
SCREEN_SPEC_3:
- exact_screen_title: Settings and Preferences - PulseBoard Canary
...
SCREEN_SPEC_4:
- exact_screen_title: Empty and Error Recovery - PulseBoard Canary
